# Lab 3 - Grove Buzzer Experiment 
## Introduction
Grove Buzzer module is a Digital ON/OFF buzzer. The buzzer buzzes on for 0.5 second and then off for 0.5 second. It is either fully ON or fully OFF. It can be controlled via a digital pin.
...
## Reporting Bugs
[Issues](https://github.com/priyankkalgaonkar/TALab3BBuzzerECE595/issues) can be used to keep track of bugs, enhancements, or other requests. For more information, see [Creating an Issue](https://docs.github.com/en/issues/tracking-your-work-with-issues/creating-an-issue). You are encouraged to create an issue if you need to report a bug or request an enhancement.

## Discusstions
GitHub Discussions is a collaborative communication forum. You can ask and answer questions, share updates, have open-ended conversations, and follow along on relevant decisions. Click on the [Discussions](https://github.com/priyankkalgaonkar/TALab3BBuzzerECE595/discussions) tab on the top to get strated.
